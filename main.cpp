...
//{
//public:
//    using MDeck = std::array<Card, 52>;
//    using MIndex = MDeck::size_type;
//
//private:
//    std::array<Card, 52> m_deck {};
//    MIndex m_cardIndex{0};
//
//public:
//    Deck() 
//    {
...
//}
//
//Numbers generateNums(int start, int length, int multiple)
//{
//	Numbers v(static_cast<Numbers::size_type>(length));
//
...
//	}
//
//	std::cout << "I generated " << length << " square numbers. Do you know what "
...
//	int multiple{2};
//
//	Numbers v = { generateNums(start, length, multiple) };
//
//
//	bool gameOver = false;
//	while (!gameOver)
...
//			if (length == 0)
//			{
//				std::cout << "You found all the numbers! YOU WIN!\n";
//				break;
//			}
//
//			else
//			{
//				std::cout << "CORRECT! There are " << length << " more numbers.\n";
//			}
//		}
//	}
//	return 0;
